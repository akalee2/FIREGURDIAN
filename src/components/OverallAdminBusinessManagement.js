  ...
  return (
    <div className="overall-admin-business-management">
      ...
      <div className="dashboard-main-container">
        <h1 className="dashboard-title">사업장 1 안전 현황</h1> {/* 선택된 사업장 이름 반영 */}

        <div className="content-layout-grid">
          {/* 왼쪽 사이드바 - 사업장 검색 및 목록 */}
          <div className="sidebar-section">
            <div className="sidebar-search-box">
              <input type="text" placeholder="사업장 검색" className="sidebar-search-input" />
              <button className="sidebar-search-button">검색</button>
            </div>
            <div className="sidebar-branch-list">
              <div className="list-title">사업장 검색</div>
              <ul>
                {branches.map(branch => (
                  <li key={branch.id} className={selectedBranch.id === branch.id ? 'active' : ''} onClick={() => setSelectedBranch(branch)}>
                    {branch.name}
                  </li>
                ))}
              </ul>
            ...
            <div className="main-content-grid-inner">
              ...
              <div className="grid-item safety-score-section">
                ...
                <div className="score-display">
                  ...
                  <div className="score-status-label">{selectedBranch.scoreStatus}</div>
